...
<!-- 
                            <p style="margin: 0; font-size: 16px; line-height: 1.6; color: rgba(255,255,255,0.9); max-width: 400px; margin: 0 auto;">
                                Un client viens de passer une réservation.
                            </p> -->
                        </td>
                    </tr>
                                    ...
                                    <td>
                                            ...
                                            <tr>
                                                <td style="vertical-align: top;">
                                                    <p style="margin: 0;  line-height: 1.6;  max-width: 400px; margin: 0 auto;">
                                                        Nous avons le plaisir de confirmer votre réservation. Une expérience gastronomique exceptionnelle vous attend.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                ...
                                                <td style="vertical-align: top;">
                                                    <h4 style="margin: 0 0 5px; color: #8B7355; font-size: 14px; font-weight: bold; text-transform: uppercase;">Réservation au nom de</h4>
                                                    <p style="margin: 0 0 3px; color: #2C2C2C; font-size: 18px; font-weight: bold;">M. Dupont</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td style="text-align: center;">
                                        <p style="margin: 0 0 8px; color: rgba(255,255,255,0.8); font-size: 12px;">
                                            © 2025 CrazyWolf - Tous droits réservés
                                        </p>
                                        <!-- <p style="margin: 0; font-size: 11px;">
                                            <a href="#" style="color: rgba(255,255,255,0.6); text-decoration: none;">Se désabonner</a>
