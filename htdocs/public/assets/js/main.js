...
; (function ($) {
    ...
    var menuModal = function() {
        if ($('#menuModal').length) {
            var $mainImage = $('#mainMenuImage');
            var $thumbnails = $('.menu-thumbnail');
            var $carouselImages = $('#menuCarousel .carousel-item img');

            // Handle click on a thumbnail
            $thumbnails.on('click', function() {
                var newSrc = $(this).attr('src');
                $('#mainMenuImage').attr('src', newSrc);
                $thumbnails.removeClass('active');
                $(this).addClass('active');
            });

            // Set the initial state when the modal is shown
            $('#menuModal').on('show.bs.modal', function () {
                var firstThumbnail = $('.menu-thumbnail').first();
                $('#mainMenuImage').attr('src', firstThumbnail.attr('src'));
                $thumbnails.removeClass('active');
